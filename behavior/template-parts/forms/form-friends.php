...
<div class="form-wrapper">
    <div class="form-title">
        <div class="title">טופס הצטרפות - חברים</div>
    ...
    <form id="pelepay-form"
        ...
        <div class="field-wrapper space-between">
            ...
            <span class="required">
                ...
                <input id="first-name" type="text" name="first-name"></span>
            </span>
        ...
        <div class="field-wrapper">
            <div class="block-name required">סוג הסמכה:</div>
            <div class="block-fields column">
                <p>BCBA-D <input type="radio" name="certification-type" value="BCBA-D"></p>
                <p>BCBA <input type="radio" name="certification-type" value="BCBA"></p>
                <p>BCaBA <input type="radio" name="certification-type" value="BCaBA"></p>
            </div>
        </div>

        <div class="field-wrapper required">
            <label for="certification-number">מס רישוי:</label>
            <input id="certification-number" type="text" name="certification-number">
        </div>
        ...
        <input type="hidden" id="pelepay-membership-type" value="חברים" name="description">
