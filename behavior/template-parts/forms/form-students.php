...
<div class="form-wrapper">
    <div class="form-title">
        <div class="title">טופס הצטרפות - סטודנטים</div>
...
מטרות הארגון, תקנון הארגון והקוד האתי כפי שמופיעים באתר האינטרנט של הארגון, ידועים ומוכרים לי.
    ...
    <form id="pelepay-form"
        ...
        <input type="hidden" name="form_type" value="students">
        ...
        <div class="field-wrapper">
            <label for="student-certificate">מצורף בזאת אישור לימודים:</label>
        ...
        <input type="hidden" id="pelepay-membership-amount" value="75" name="amount">
        <input type="hidden" id="pelepay-membership-type" value="סטודנטים" name="description">
